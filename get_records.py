"""
Este script se conecta a un analizador de gases a través de Telnet y descarga registros largos (lrec) en un archivo de texto.
El analizador de gases es un modelo 48i o 42i de Thermo Scientific, y el puerto Telnet es 9880.
El script permite especificar la cantidad de días de datos a descargar y el archivo de salida.
Se recomienda ejecutar el script en un entorno virtual de Python para evitar conflictos de dependencias.
"""
...
def main():
    # cargo la configuración del archivo config.json
